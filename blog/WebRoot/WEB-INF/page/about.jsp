	...
	<div class="navbar-inner">
		<div class="container">
			...
			<ul class="nav">
				...
				<li><a href="/html/about/about.shtml" title="${setSettings.description}">关于</a></li>
			</ul>
		</div>
	</div>
</div>
	...
	<div class="row-fluid">
		...
		<div class="span9">
			<div class="well well-large blog-content">
				...
				<!-- 多说评论框 start -->
				<div class="ds-thread" data-thread-key="1" data-title="关于本站|小倪的博客" data-url="/html/about/about.shtml"></div>
				<!-- 多说评论框 end -->
			</div>
		</div>
		<!-- Sidebar content -->
		<div class="span3">
			...
			<div class="article-classify">
				...
				<li>
				${statu.count}.<a href="<html:rewrite action='/article/view'/>?url=${entry.url}" target="_blank" title="${entry.name}">${fn:substring(entry.name,0,15)}<span class="article-date">${entry.createdate}</span></a>
				</li>
				</c:forEach>
				</ul>
			</div>
